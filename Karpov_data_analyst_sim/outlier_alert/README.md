...
Based on an analysis of metric behavior statistical detection method was chosen. 3 sigma and interquartile range (IQR) methods were tested and the IQR method was selected for anomaly detection. When an abnormal value is detected, the system sends an alert
